...
public abstract class StringUtils {
    ...
    public static void main(String[] args) {
        System.out.println(validateString(" 6544", "\\d{6}"));
    }
    ...
    public static Map<String, String> getMapForEntryAlls(Object o) {
        Map<String, String> map = new HashMap<String, String>();
        try {
            Field[] fields = o.getClass().getFields();
            for (Field f : fields) {
...
//                    }
    ...
    /**
     * 此方法判断字符串是否只由这三种字符串组成【中文、数字、英文】
     * @param str  需要判断的字符串
     * @return true 只由这三种字符串组成【中文、数字、英文】
     *         false 含有其他符号
     */
    public static boolean matcherNoSymbol(String str){
