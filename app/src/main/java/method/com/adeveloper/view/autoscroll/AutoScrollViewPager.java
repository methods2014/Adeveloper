...
//        Log.d(TAG, "dispatchTouchEvent: ");
        if (stopScrollWhenTouch) {
            if ((action == MotionEvent.ACTION_DOWN) && isAutoScroll) {
                isStopByTouch = true;
                stopAutoScroll();
//                Log.d(TAG, "dispatchTouchEvent: stopAutoScroll");
            } else if ((action == MotionEvent.ACTION_UP || action == MotionEvent.ACTION_CANCEL) && isStopByTouch) {

//                Log.d(TAG, "dispatchTouchEvent: startAutoScroll");
                startAutoScroll();
            }
        }
...
//                        Log.d(TAG, "handleMessage: SCROLL_WHAT");
                    }
                default:
                    break;
            }
